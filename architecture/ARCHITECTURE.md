...
- 2026-07-09 — ST-001 (first formal stress test) executed against the framework using DD-006 v0.1, in the private THA-Lab repository. 14 scoped findings recorded (4 Moderate, rest Low/Low–Moderate), plus 7 gaps in the methodology itself. DD-006's status updated above; no framework content changed yet — findings pending review.
- 2026-07-12 — V2: added SOURCES.md (evidence register), The Human Condition, Signal and Noise, The Drift Test; renumbered notes 08–35.
