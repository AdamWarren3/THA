...
[[Constructive Displacement]] is intentionality architecture applied to conflict — building the replacement rather than spending the architecture on opposing what's already there.

[[The Human Algorithm]] is intentionality architecture made explicit — the framework for designing the system rather than just running it.
